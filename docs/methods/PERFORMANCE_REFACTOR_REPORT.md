...
Built the CLI once (`go build ./cmd/replicated-local-structure-audit`) and ran
...
- `go test ./cmd/normalization-compare/... ./internal/sequenceanalyze/... ./cmd/sequence-analyze/...`:
  all pass, including the pre-existing tests for both packages.
- `go vet ./...`, `gofmt -l`: clean.
- `go test -race ./internal/sequenceanalyze/... ./cmd/normalization-compare/...`: clean.
...
`go test ./cmd/normalization-compare/...` all clean; backlog item 2's own
