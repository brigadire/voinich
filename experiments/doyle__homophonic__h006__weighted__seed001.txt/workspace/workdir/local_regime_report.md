...
|---|---:|---:|---:|---:|
| `x014952` / `x030834` | 0.8096 | 0.1911 | 0.7374 | -0.5463 |

## Correlation diagnostic

regime_js_vs_distance_js_1_5: Pearson 0.0000, Spearman 0.0000 (N=1). These are descriptive diagnostics; ordinary independent-pair p-values are not used.

Detected 2774 neutral distributional change points by a mean-plus-one-standard-deviation JS-jump threshold. Parameter sweeps are retained in YAML and no radius, gap, block size, or number of regimes was selected post hoc.
