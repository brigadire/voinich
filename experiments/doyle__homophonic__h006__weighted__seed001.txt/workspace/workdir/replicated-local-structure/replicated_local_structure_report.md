...
Confirmatory audit of frozen candidates only. Corpus SHA256: `cdf533ee521a4e8ebb2dc64c3b862c33fc35de8452456a3e2daf58e5232a383c`. No token pairs, n-grams, distances, thresholds, or classification rules were added or changed.
...
- distance-profile: 1 frozen, 0 FDR-significant, 0 robust cross-block, 0 artifact/invalid.
- sequence: 200 frozen, 189 FDR-significant, 0 robust cross-block, 200 artifact/invalid.

## Distance-profile distributions

Frozen median similarity: q<=0.05 primary set median 0 (n=0); q>0.05 descriptive set median 0 (n=1). This comparison performs no new selection or significance test.
...
Length distribution: n=2: 199; n=3: 1;

Canonical occurrence distribution: min 3, median 6.0, mean 6.76, P90 10.0, max 23.

Diagnostic statuses:
- TRANSCRIPTION_AMBIGUOUS: 200
