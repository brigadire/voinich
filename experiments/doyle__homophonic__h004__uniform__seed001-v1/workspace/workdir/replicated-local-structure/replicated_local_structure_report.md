...
Confirmatory audit of frozen candidates only. Corpus SHA256: `d44a2dabd08cf969d23a2ec4e91f719eb9da85f49f966184f31aa40f745dead9`. No token pairs, n-grams, distances, thresholds, or classification rules were added or changed.
...
- distance-profile: 8 frozen, 0 FDR-significant, 0 robust cross-block, 0 artifact/invalid.
- sequence: 201 frozen, 192 FDR-significant, 0 robust cross-block, 201 artifact/invalid.

## Distance-profile distributions

Frozen median similarity: q<=0.05 primary set median 0 (n=0); q>0.05 descriptive set median 0 (n=8). This comparison performs no new selection or significance test.
...
Length distribution: n=2: 200; n=3: 1;

Canonical occurrence distribution: min 3, median 7.0, mean 8.05, P90 13.0, max 19.

Diagnostic statuses:
- TRANSCRIPTION_AMBIGUOUS: 201
