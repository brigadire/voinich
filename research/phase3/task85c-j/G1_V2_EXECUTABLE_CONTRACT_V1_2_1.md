# G1-v2 executable scientific contract V1.2.1

Version: `G1_V2_EXECUTABLE_CONTRACT_V1_2_1`. This document incorporates every unchanged V1.1 scientific rule below. For generation, the machine artifacts bound by the V1.2.1 JSON replaces conflicting V1.1 generation prose.

## Normative V1.2.1 generation binding
