...
- Commit: `16b0b1a8160159e3310bfadb6f43aa2dba0af7bb`
- Seed/repetitions: `20260824` / `100`
- Primary corpus: `voynich-it2a-eva`; tokens `37945`; types `8069`; SHA-256 `10286ee7e11ad974e9d0f884e3b0df1b588745a4b77ad428a638a5ff63946a8b`
- LP1 support Gini: `0.780164`; top-rule share: `0.00875159`
- EF1 edges/isolates/giant share: `40964` / `942` / `0.874582`
- EF2 clustering/triangles/3-paths/4-cycles: `0.279163` / `71489` / `768250` / `565594`
- EF3 Spearman(degree, log frequency): `0.63375`
...
- Lines/loci/folios: `5207` / `5207` / `225`
- **INPUT_RESULTS_REPRODUCED:** `PARTIALLY_SUPPORTED` — task75/task77 audit includes one NOT_TESTABLE transcription block
- **METADATA_INTEGRITY_ACCEPTABLE:** `SUPPORTED` — 37945 tokens, 5207 lines, 5207 loci, 225 folios; nesting violations=0
