...
candidate_id=`C01` representation_id=`LATIN-EXPANDED` checkpoint=`39380` reachable=`false`
...
Corpus size 19132 is below checkpoint 39380; every metric is NOT_COMPARABLE at this checkpoint by frozen protocol rule.
