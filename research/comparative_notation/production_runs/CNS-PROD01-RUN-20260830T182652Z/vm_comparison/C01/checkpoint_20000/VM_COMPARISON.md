...
candidate_id=`C01` representation_id=`LATIN-EXPANDED` checkpoint=`20000` reachable=`false`
...
Corpus size 19132 is below checkpoint 20000; every metric is NOT_COMPARABLE at this checkpoint by frozen protocol rule.
