...
candidate_id=`C02` representation_id=`LATIN-DIPLOMATIC` checkpoint=`39380` reachable=`false`
...
Corpus size 19121 is below checkpoint 39380; every metric is NOT_COMPARABLE at this checkpoint by frozen protocol rule.
