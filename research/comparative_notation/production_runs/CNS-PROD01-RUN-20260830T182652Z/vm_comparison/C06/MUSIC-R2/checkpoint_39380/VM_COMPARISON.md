...
candidate_id=`C06` representation_id=`MUSIC-R2` checkpoint=`39380` reachable=`false`
...
Corpus size 11785 is below checkpoint 39380; every metric is NOT_COMPARABLE at this checkpoint by frozen protocol rule.
