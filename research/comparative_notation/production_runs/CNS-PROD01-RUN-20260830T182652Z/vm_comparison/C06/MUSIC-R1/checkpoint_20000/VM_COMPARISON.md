...
candidate_id=`C06` representation_id=`MUSIC-R1` checkpoint=`20000` reachable=`false`
...
Corpus size 13117 is below checkpoint 20000; every metric is NOT_COMPARABLE at this checkpoint by frozen protocol rule.
