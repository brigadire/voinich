...
var stages = []Stage{
	...
	{Name: "token-relation-validate", SourceDir: "token-relation-validate", Quiet: true, Checkpoint: true, Executor: true, CorpusFlag: "-corpus", RequiresMetadata: true, Generic: GenericSupport{Applicable: true}},
	{Name: "replicated-local-structure-audit", SourceDir: "replicated-local-structure-audit", Quiet: true, Checkpoint: true, Executor: true, CorpusFlag: "-corpus", RequiresMetadata: true, Generic: GenericSupport{Applicable: true}},
